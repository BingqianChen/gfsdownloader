...
public class Publish {
    ...
    private static final String user = ConfigUtil.getProperty("apollo_user");
    private static final String password =  ConfigUtil.getProperty("apollo_password");
    private static final String host = ConfigUtil.getProperty("apollo_host");
    private static final int port = ConfigUtil.getInteger("apollo_port");
